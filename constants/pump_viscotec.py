...
D_C = 0.004  # coupler diameter [m]
L_C = 0.021  # coupler length [m]
...
L_S = 0.030  # length of stator [m]

A_CAV = 2.5e-6  # area of inner cavity of pump [m^2]
N_CAV = 2  # number of pump inner cavities at the inlet [1]
PHI = 10  ## angle of attack of pump cavity [deg]
...
W_GAP = 0.65*R_SI # slip gap height [m] (TYP: 0.7)
L_GAP = 0.65*R_SI # slip gap depth [m]  (TYP: 0.7)
K_S = 1.1 # shape adjustment factor for Couette flow [1]

EXTRUSION_RATIO = 2*4.77e-09  # volume of extrusion per rotor revolution, FOR THE VISCOTEC PUMP[m^3/rad]
